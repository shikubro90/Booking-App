...
const Featured = () => {
    return (
        <div className="featured">
            ...
            <div className="featuredItem">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTLZGnJfOIAjlFFEHqG6kGTw7mWC5OQOodqBNyU1230GZZMnwQay7RpgW8h26rJ6nR-cxA&usqp=CAU" alt="" className="featuredImage" />
