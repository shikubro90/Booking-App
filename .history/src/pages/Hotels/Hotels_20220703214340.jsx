        ...
        <div>
            ...
            <div className="hotelContainer">
                ...
                {open && <div className="slider">
                    ...
                    <FontAwesomeIcon className="arrowIcon" icon={faCircleArrowLeft} onClick={()=>handleMode(i)}/>
                    <div className="sliderWrapper">
                        <img src={photos[slideNumber].src} alt="" className='sliderImage' />
                    </div>
                    <FontAwesomeIcon className="arrowIcon" icon={faCircleArrowRight} onClick={()=>handleMode(i)}/>
                </div>}
