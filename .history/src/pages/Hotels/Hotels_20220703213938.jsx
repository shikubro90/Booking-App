        ...
        <div>
            ...
            <div className="hotelContainer">
                ...
                {open && <div className="slider">
                    <FontAwesomeIcon icon={faCircleXmark} className="closeIcon" onClick={()=>setOpen()} />
                    <FontAwesomeIcon className="arrowIcon" icon={faCircleArrowLeft} />
                    <div className="sliderWrapper">
                        <img src={photos[slideNumber].src} alt="" className='sliderImage' />
                    </div>
                    <FontAwesomeIcon className="arrowIcon" icon={faCircleArrowRight} />
                </div>}
