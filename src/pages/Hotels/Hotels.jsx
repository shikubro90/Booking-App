...
const Hotels = () => {
    ...
    const handleMove = (direction)=>{
        ...
        if(direction==="l"){
            newDirection = slideNumber === 0 ? 5 : slideNumber-1;
        }else{
            newDirection = slideNumber === 5 ? 0 : slideNumber+1;
        }
        
        setSlideNumbre(newDirection)
    }
        ...
        <div>
            ...
            <div className="hotelContainer">
                ...
                {open && <div className="slider">
                    ...
                    <FontAwesomeIcon className="arrowIcon" icon={faCircleArrowLeft} onClick={()=>handleMove("l")}/>
                    <div className="sliderWrapper">
                        <img src={photos[slideNumber].src} alt="" className='sliderImage' />
                    </div>
                    <FontAwesomeIcon className="arrowIcon" icon={faCircleArrowRight} onClick={()=>handleMove("r")}/>
                </div>}
